...
const Map = ({ selectedH3Indices, onHexClick, points, }) => {
    ...
    //@ts-ignore
    if (((_a = layers[0].props) === null || _a === void 0 ? void 0 : _a.data.length) == 0)
        renderLayers();
    getTooltip = (info) => {
        if (info.object) {
    ...
    return (_jsx(DeckGL, Object.assign({ height: HEIGHT, width: WIDTH, initialViewState: viewState, onViewStateChange: ({ viewState }) => setViewState(viewState), controller: {
            scrollZoom: {
                smooth: true,
            }
        }, layers: layers }, { children: _jsx(ReactMapGL, Object.assign({}, {
